				...
				<div class="col-sm-7">
					...
					<p>
						<h3>Vote for a better Tomorrow.</h3>
							<h3><br> ELECTIONS is an Electronic Voting system which allows electronic casting and counting of votes in a secured
							...
							<div class="col-sm-12">
								<div class="container">
									...
									<form id="validateform" name="login" method="post" action="LoginControl.php">
										...
										<center>
											<label>Forget Password? <a href="forgotpass.php" id="Signup">Click here</a></label>
										</center>
									</form>
								</div>
							</div>
