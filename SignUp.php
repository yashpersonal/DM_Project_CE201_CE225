...
<div class="container-fluid bg-3 text-center">
	<div class="row">
		...
		<div class="form-group">
		<input type="text" minlength="10" maxlength="10" pattern="[0-9]{10}" class="form-control" name="mobileno" class="textsize" id="mobileno" placeholder="Enter your Mobile Number : " >
		</div>
		<div class="form-group">
